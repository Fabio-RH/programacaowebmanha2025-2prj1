...
@Tag(name="Participante", description="API para gerenciamento de participante")
public class ParticipanteController {
    ...
    @Operation(summary="Listar participantes pelo id de participante", description = "Endpoint para participante pelo id de participante")
    ...
    @PostMapping("/criar")
    @Operation(summary = "Criar um novo participante", description = "Endpoint apra criar um novo registro de participante")
